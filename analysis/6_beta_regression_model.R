...
# parr mark area
plogis(as.numeric(summary_table[15, 4]) + as.numeric(summary_table[16, 4])) - plogis(as.numeric(summary_table[15, 4]))
...
# parr mark area
# Family
plogis(as.numeric(summary_table[15, 4]) + as.numeric(summary_table[19, 4])) - plogis(as.numeric(summary_table[15, 4]))
# stream
plogis(as.numeric(summary_table[15, 4]) + as.numeric(summary_table[20, 4])) - plogis(as.numeric(summary_table[15, 4]))
...
silvering_treatment_plot <- ggplot() + 
  geom_point(data = silvering_treatment_emm, aes(x = x , y = predicted, colour = c("Control","Treatment"))) +
  geom_errorbar(data = silvering_treatment_emm, aes(x = x , y = predicted, ymin = conf.low, ymax = conf.high, colour = c("Control","Treatment")), width= 0.1) +
  theme(panel.grid.major = element_blank(), axis.title.x = element_text(size = 12), axis.title.y = element_text(size = 12),
        panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black"),
        legend.position = "none") +
...
# Orange spots
orange_spot_treatment_plot <- ggplot() + 
  geom_point(data = orange_spot_treatment_emm, aes(x = x , y = predicted, colour = c("Control","Treatment"))) +
  geom_errorbar(data = orange_spot_treatment_emm, aes(x = x , y = predicted, ymin = conf.low, ymax = conf.high, colour = c("Control","Treatment")), width= 0.1) +
  theme(panel.grid.major = element_blank(), axis.title.x = element_text(size = 12), axis.title.y = element_text(size = 12),
        panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black"),
        legend.position = "none") +
...
# Parr marks
parr_mark_treatment_plot <- ggplot() + 
  geom_point(data = parr_mark_treatment_emm, aes(x = x , y = predicted, colour = c("Control","Treatment"))) +
  geom_errorbar(data = parr_mark_treatment_emm, aes(x = x , y = predicted, ymin = conf.low, ymax = conf.high, colour = c("Control","Treatment")), width= 0.1) +
  theme(panel.grid.major = element_blank(), axis.title.x = element_text(size = 12), axis.title.y = element_text(size = 12),
        panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black"),
        legend.position = "none") +
...
silvering_treatment_plot + orange_spot_treatment_plot + parr_mark_treatment_plot
